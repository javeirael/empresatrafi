...
export function fDurationHours(durationHours) {
  return dayjs.duration(durationHours, 'hours').hours();
}

export function fDurationMinutes(durationMinutes) {
  return dayjs.duration(durationMinutes, 'minutes').minutes();
}
